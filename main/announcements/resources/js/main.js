...
// lembrar de incluir a variavel lang ComunicadoDeAusencia no arquivo announcement.inc.php
function registrar_ausencia() {
    "use strict";
    if (document.getElementById('options_ausencia').style.display == 'none') {
        document.getElementById('options_ausencia').style.display = 'block';
        document.getElementById('ausencia').innerHTML = '&nbsp;<img style="vertical-align:middle;" src="../img/div_hide.gif" alt="" />&nbsp;' + lang.ComunicadoDeAusencia;
    } else {
        document.getElementById('options_ausencia').style.display = 'none';
        document.getElementById('ausencia').innerHTML = '&nbsp;<img style="vertical-align:middle;" src="../img/div_show.gif" alt="" />&nbsp;' + lang.ComunicadoDeAusencia;
    }
}
// End
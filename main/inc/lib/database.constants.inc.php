...
//Ausencia
define('TABLE_AUSENCIA', 'ausencia');
define('TABLE_AUSENCIA_CATEGORIA', 'ausencia_categoria');
define('TABLE_AUSENCIA_REL_USER', 'ausencia_rel_user');

// Grade curricular
define('TABLE_GRADE_CURRICULAR', 'grade_curricular');
define('TABLE_GRADE_REL_AGRUPAMENTO', 'grade_rel_agrupamento'); 
define('TABLE_GRADE_AGRUPAMENTO', 'grade_agrupamento');

...
class Autoload
{
    ...
    static public function &map()
    {
        ...
        $result['SurveyUtil'] = '/main/inc/lib/survey.lib.php';
        ...
        $result['ch_comment'] = '/main/inc/lib/survey.lib.php';
        $result['ch_dropdown'] = '/main/inc/lib/survey.lib.php';
        $result['ch_multiplechoice'] = '/main/inc/lib/survey.lib.php';
        $result['ch_multipleresponse'] = '/main/inc/lib/survey.lib.php';
        $result['ch_open'] = '/main/inc/lib/survey.lib.php';
        $result['ch_pagebreak'] = '/main/inc/lib/survey.lib.php';
        $result['ch_percentage'] = '/main/inc/lib/survey.lib.php';
        $result['ch_personality'] = '/main/inc/lib/survey.lib.php';
        $result['ch_score'] = '/main/inc/lib/survey.lib.php';
        $result['ch_yesno'] = '/main/inc/lib/survey.lib.php';
        ...
        $result['survey_manager'] = '/main/inc/lib/survey.lib.php';
        $result['survey_question'] = '/main/inc/lib/survey.lib.php';
